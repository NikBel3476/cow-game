...
import * as lvl7 from './json/lvl7.json';
import * as lvl8 from './json/lvl8.json';
import * as lvl9 from './json/lvl9.json';
import * as lvl10 from './json/lvl10.json';
import * as lvl11 from './json/lvl11.json';
import * as lvl12 from './json/lvl12.json';
...
import * as lvl24 from './json/lvl24.json';
import * as lvl25 from './json/lvl25.json';

// TODO: change level structure
