class Game {
   ...
   /* initMobileFields(mobileFields: ILevel['mapObjects']['mobileFields']) {
    ...
    findMapFieldByHtmlElement(htmlElement: HTMLElement): Field {
                ...
                Object.values(this.cows).forEach((cow: Cow) => {
                        switch (cow.direction) {
                            case "Up":
                                ...
                                Object.values(this.staticFields).forEach((field: Field) => {
                                    if (
                                        cow.coordinates.x === field.coordinates.x &&
                            ...
                            case "Right":
                                ...
                                Object.values(this.staticFields).forEach((field: Field) => {
                                    if (
                                        (cow.coordinates.x + 1) === field.coordinates.x &&
